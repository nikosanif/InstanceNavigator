 ...
 */
package gr.forth.ics.isl.instancenavigator.instances.data;
...
public class Instances {
    ...
    ArrayList<InstanceRecord> instances;
    ArrayList<TS_Class> classes;

    public ArrayList<InstanceRecord> getInstances() {
        return instances;
    }

    public void setInstances(ArrayList<InstanceRecord> instances) {
        this.instances = instances;
    }
    
    public void addInstance(InstanceRecord instance) {
    ...
    public void addClass(TS_Class clazz) {
